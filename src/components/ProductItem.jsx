...
const ProductItem = ({ product }) => {
    ...
    return (
        <div className="group">
            <Link to={`/products/${product._id}`} className="block bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg">
