...
import { User, Mail, Calendar, RefreshCw, Briefcase, ShoppingCart, ShoppingBag, Boxes, BadgeDollarSign } from 'lucide-react';
  ...
  return (
    <div className="">
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4 pt-6'>
        ...
        />
        <InfoItem
          icon={<User className="w-6 h-6 text-red-400" />}
          title="Total Buyer"
          value={2 || 'N/A'}
        />
        <InfoItem
          icon={<BadgeDollarSign className="w-6 h-6 text-green-400" />}
